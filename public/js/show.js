...
/* WEBPACK VAR INJECTION */(function($) {new Vue({
    ...
    methods: {
         ...
         * @returns {boolean}
         */
        isCommentOwner: function isCommentOwner(user) {
            if (!this.user) {
                return false;
            }
        ...
        saveComment: function saveComment(comment) {
            ...
            axios.put('/comments/' + comment.id, { body: body }).then(function (response) {
         ...
         * @param comment
         */
        confirmDeleteComment: function confirmDeleteComment(comment) {
            var _this = this;

            axios.delete('/comments/' + comment.id).then(function (response) {
                location.href = '/posts/' + _this.post.id;
            });
        }
    }
});
